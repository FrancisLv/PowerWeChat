...
import (
	...
	"github.com/FrancisLv/PowerWeChat/v3/src/officialAccount/customerService/request"
	"github.com/FrancisLv/PowerWeChat/v3/src/officialAccount/customerService/response"
)
