...
import (
	...
	"github.com/FrancisLv/PowerWeChat/v3/src/officialAccount/broadcasting/request"
	"github.com/FrancisLv/PowerWeChat/v3/src/officialAccount/broadcasting/response"
)
