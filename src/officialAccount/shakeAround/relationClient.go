...
import (
	...
	"github.com/FrancisLv/PowerWeChat/v3/src/officialAccount/shakeAround/request"
	"github.com/FrancisLv/PowerWeChat/v3/src/officialAccount/shakeAround/response"
)
