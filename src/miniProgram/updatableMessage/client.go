...
import (
	...
	"github.com/FrancisLv/PowerWeChat/v3/src/miniProgram/updatableMessage/request"
	"github.com/FrancisLv/PowerWeChat/v3/src/miniProgram/updatableMessage/response"
)
