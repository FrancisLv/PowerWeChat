...
import (
	...
	"github.com/FrancisLv/PowerWeChat/v3/src/openPlatform/authorizer/aggregate/account"
	"github.com/FrancisLv/PowerWeChat/v3/src/openPlatform/authorizer/officialAccount/account/response"
)
