...
import (
	...
	"github.com/FrancisLv/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/setting/request"
	"github.com/FrancisLv/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/setting/response"
)
