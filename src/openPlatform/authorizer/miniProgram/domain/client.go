...
import (
	...
	"github.com/FrancisLv/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/domain/request"
	"github.com/FrancisLv/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/domain/response"
)
